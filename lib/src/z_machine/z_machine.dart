...
class ZMachine {
  ...
  ZIoDispatcher io = DefaultProvider([]) as ZIoDispatcher;
  ...
  void runIt() async {
    ...
    if (inBreak) {
      await Z.sendIO({"command": ZIoCommands.printDebug, "message": "<<< DEBUG MODE >>>"});
      callAsync(Debugger.startBreak);
    }
  }
  ...
  /// [maxChars]: Maximum number of characters to accept.
