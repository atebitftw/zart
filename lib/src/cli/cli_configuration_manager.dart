...
/// The global configuration manager for Zart CLI.
final CliConfigurationManager cliConfigManager = CliConfigurationManager();

/// Manages persistent configuration for Zart CLI, including key bindings.
