...
class TerminalDisplay {
  // Terminal dimensions
  int _cols = 80;
  int _rows = 24; // Default to 24 rows, but resizes later if possible.
  ...
  String _fgAnsi(int zColor) {
    ...
    switch (zColor) {
      ...
      case 10:
        return '\x1B[38m'; // Light Grey
      case 11:
        return '\x1B[38m'; // Medium Grey
      case 12:
        return '\x1B[38m'; // Dark Grey
      default:
        return '';
    }
  }
  ...
  String _bgAnsi(int zColor) {
    ...
    switch (zColor) {
      ...
      case 10:
        return '\x1B[48m'; // Light Grey
      case 11:
        return '\x1B[48m'; // Medium Grey
      case 12:
        return '\x1B[48m'; // Dark Grey
      default:
        return '';
    }
  }
