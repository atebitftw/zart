...
// what is this comment below? "atere"??
//atere
  static const List<String> DEFAULT_TABLE = const [
    'abcdefghijklmnopqrstuvwxyz',
    'ABCDEFGHIJKLMNOPQRSTUVWXYZ',
    '  0123456789.,!?_#\'"/\\-:()', // this has an extra space in the front, not sure why?
  ];

  static const int PAD = 5;

  static const Map<String, int> UNICODE_TRANSLATIONS = const {
    '155': 0xe4,
    '156': 0xf6,
    '157': 0xfc,
    '158': 0xc4,
  ...
  static int CharToZChar(String c) {
    if (c.isEmpty || c.length != 1) {
      throw GameException('String must be length of 1.  Found $c.');
    }
