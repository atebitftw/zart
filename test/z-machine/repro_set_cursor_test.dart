...
class MockIoProvider extends ZIoDispatcher {
  final List<Map<String, dynamic>> commands = [];

  @override
  Future<dynamic> command(Map<String, dynamic> ioData) async {
    commands.add(ioData);
    if (ioData['command'] == ZIoCommands.read) return "quit";
    return null;
  }
...
void main() {
  ...
  test('Verification: Header Cursor Position Update (Beyond Zork Compat)', () async {
    ...
    expect(Z.engine.mem.loadb(0x24), equals(0), reason: "Header Row (0x24) should NOT be modified by set_cursor");
    ...
    expect(Z.engine.mem.loadb(0x24), equals(0), reason: "Header Row (0x24) should NOT be modified by erase_window");
  });
}
