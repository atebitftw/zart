...
void main() {
  group('GameObject Property Defaults (Version Dependent)', () {
    test('V3 (Minizork) - Max 31 properties', () {
      loadGame('assets/games/z/minizork.z3');
      expect(
        Z.engine.version,
        equals(ZMachineVersions.v3),
        reason: 'Should be Version 3',
      );
    ...
    test('V5 (Adventureland) - Max 63 properties', () {
      loadGame('assets/games/z/adventureland.z5');
      expect(
        Z.engine.version,
        equals(ZMachineVersions.v5),
        reason: 'Should be Version 5',
      );
    ...
    test('V8 (Anchorhead) - Max 63 properties', () {
      loadGame('assets/games/z/anchor.z8');
      expect(
        Z.engine.version,
        equals(ZMachineVersions.v8),
        reason: 'Should be Version 8',
      );

      // Should work for 1-63
      expect(GameObject.getPropertyDefault(1), isA<int>());
      expect(
        GameObject.getPropertyDefault(35),
        isA<int>(),
        reason: 'Property 35 should be valid in V8',
      );
      expect(GameObject.getPropertyDefault(63), isA<int>());
