...
void main() {
  ...
  group('Z Memory> ', () {
    ...
    test(
      ...
      () {
        expect(
          Z.engine.mem.loadw(Header.programCounterInitialValueAddr),
    ...
    test(
      'Z.machine.mem.storew() correctly writes and reads an expected value.',
      () {
        ...
        Z.engine.mem.storew(
          Header.programCounterInitialValueAddr,
    ...
    test(
      ...
      () {
        expect(
          Z.engine.mem.loadw(Z.engine.mem.globalVarsAddress + 8),
          equals(8101),
        );
      },
    );
