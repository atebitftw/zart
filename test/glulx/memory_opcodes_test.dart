...
void main() {
  group('Memory Opcodes', () {
    ...
    test('mzero zeroes out memory range', () async {
      ...
      gameData = createGameData([0x81, 0x70, 0x31, 0x05, 0x00, 0x00, 0x03, 0x00]);
    ...
    test('mcopy copies memory range', () async {
      ...
      gameData = createGameData([0x81, 0x71, 0x31, 0x03, 0x04, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x03, 0x10]);
      gameData[0x300] = 0xAA;
      gameData[0x301] = 0xBB;
      gameData[0x302] = 0xCC;
      gameData[0x303] = 0xDD;
