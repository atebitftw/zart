...
void main() {
  group('Binary', () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return true at position 0",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return true at position 1",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return true at position 2",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return true at position 3",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return false at position 4",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return false at position 5",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return false at position 6",
      () {
    ...
    test(
      "BinaryHelper.isSet(0xf) (15 decimal) should return false at position 7",
      () {
    ...
    test(
      ...
      () {
        ...
        expect(
          BinaryHelper.binaryOf(BinaryHelper.bottomBits(88, 6)),
