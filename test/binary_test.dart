...
void main() {
  group('Binary', () {
    ...
    test("BinaryHelper.binaryOf(0xf) (15 decimal) should be equivalent to .toRadixString(2)", () {
    ...
    test("BinaryHelper.isSet(0xf0) (240 decimal) should return false at position 0", () {
      expect(BinaryHelper.isSet(0xf0, 0), isFalse);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return false at position 1", () {
      expect(BinaryHelper.isSet(0xf0, 1), isFalse);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return false at position 2", () {
      expect(BinaryHelper.isSet(0xf0, 2), isFalse);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return false at position 3", () {
      expect(BinaryHelper.isSet(0xf0, 3), isFalse);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return true at position 4", () {
      expect(BinaryHelper.isSet(0xf0, 4), isTrue);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return true at position 5", () {
      expect(BinaryHelper.isSet(0xf0, 5), isTrue);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return true at position 6", () {
      expect(BinaryHelper.isSet(0xf0, 6), isTrue);
    });

    test("BinaryHelper.isSet(0xf0) (240 decimal) should return true at position 7", () {
      expect(BinaryHelper.isSet(0xf0, 7), isTrue);
    });

    test('BinaryHelper.bottomBits() properly returns 24 from the bottom 6 bits of 88.', () {
      expect(BinaryHelper.bottomBits(88, 6), equals(24));
      //stringify as well and test
      expect(BinaryHelper.binaryOf(BinaryHelper.bottomBits(88, 6)), equals(BinaryHelper.binaryOf(24)));
    });
